...
public class Mapreduce1 extends Configured implements Tool{
	...
	public static class Map extends Mapper<LongWritable,Text,NullWritable,Text>{
		public void map(LongWritable key,Text value,Context context)
			...
			try {
				...
				contenxt.write(NullWritable.get(),out);//输出 key \t value
	...
	public int run(String[] args) throws Exception{
		...
		job.setJarByClass(Mapreduce1.class); //指定class
	...
	public static void main(String[] args) throws Exception{
		//运行任务
		int res = ToolRunner.run(new Configuration(),new Mapreduce1(),args);
		System.exit(res);
	}
}
